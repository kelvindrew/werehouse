...
export const SharedLinksView: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
      {/* Top Banner */}
      <div className="bg-white border border-zinc-200/80 rounded-2xl shadow-xs p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
        ...
        <button
          ...
          className="inline-flex items-center space-x-2 px-4 py-2 bg-zinc-900 hover:bg-zinc-800 text-white text-xs font-semibold rounded-full shadow-xs transition-colors shrink-0"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 bg-white p-3.5 rounded-2xl border border-zinc-200/80 shadow-xs">
        <div className="sm:col-span-2 relative">
          ...
          <input
            ...
            className="w-full bg-zinc-50/80 border border-zinc-200 text-xs text-zinc-900 pl-9 pr-3.5 py-1.5 rounded-full outline-none focus:bg-white focus:border-zinc-900 transition-all"
          />
        </div>
        ...
        <div className="bg-zinc-50 border border-zinc-200 rounded-full px-4 py-1.5 flex items-center justify-between text-xs text-zinc-600 shadow-xs">
